...
<form class="form-inline m-bottom" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" enctype="multipart/form-data" method="post" class="confirm-reload">
	<div class="row">
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" name="alias" id="idalias" type="hidden" value="{rowcontent.alias}" maxlength="255"  style="width:350px"/>&nbsp; <em class="fa fa-refresh fa-lg fa-pointer" onclick="get_alias();">&nbsp;</em></td>
					</tr>
				</tbody>
			</table>
		...
		<div class="message_head">	<cite>{LANG.thongtintour}</cite></div>
<table border="0" width="100%" cellpadding="2"  class="table table-striped table-bordered table-hover">
<col class="w200" />
				<col />
				<tbody>
<tr><td style=" width: 15%;  line-height: 29px; " > {LANG.giatour}  </td> <td style=" width: 32%;  line-height: 29px; " > <input class="form-control" type="text" maxlength="20" value="{rowcontent.giatour}" id="giatour" name="giatour" style="width:95px"  placeholder="2.500.000 VNĐ"/><b>.{rowcontent.tiente}</b>
| <b style="  color: #0017FF;"> {LANG.tiente}</b>
 <input type="radio" name="tiente" checked  value="VNĐ" >VNĐ	<input type="radio" name="tiente" value="USD">USD </td>
<td style=" width: 15%;   line-height: 29px;" > {LANG.matour}  </td> <td style=" width: 32%;  line-height: 29px; " > <input class="form-control" type="text" maxlength="160" value="{rowcontent.matour}" id="matour" name="matour" style="width:100%" placeholder="" />  </td>

</tr>
<tr><td> {LANG.donvitinh}  </td><td>  <input class="form-control" type="text" maxlength="160" value="{rowcontent.donvitinh}" id="donvitinh" name="donvitinh" style="width:100%" placeholder="Khách" /> </td>
<td>  {LANG.hanhtrinh} </td><td><input class="form-control" type="text" maxlength="160" value="{rowcontent.hanhtrinh}" id="hanhtrinh" name="hanhtrinh" style="width:100%"  placeholder="2 ngày 3 đêm"/></td>

</tr>
<tr></td><td>  {LANG.khoihanh} </td><td><input class="form-control" name="khoihanh" id="publ_date" value="{rowcontent.khoihanh}" style="width: 90px;" maxlength="10" type="text"/>
</td><td>{LANG.ketthuc}</td><td><input class="form-control" name="ketthuc" id="exp_date" value="{rowcontent.ketthuc}" style="width: 90px;" maxlength="10" type="text"/></td>

</tr>
<tr></td><td>{LANG.thoigian}</td><td><input class="form-control" type="text" maxlength="160" value="{rowcontent.thoigian}" id="thoigian" name="thoigian" style="width:100%"  placeholder="2 ngày 3 đêm"/></td>
</td><td>{LANG.ghichutour}<br>{LANG.chapnhanthe}</td><td>

<textarea id="ghichutour" name="ghichutour" rows="5" cols="75" style="font-size:14px; width: 100%; height:50px;" class="form-control" placeholder="Đăng ký từ 3 khách có giảm 5% " >{rowcontent.ghichutour}</textarea>
 



<!--input class="form-control" type="text" maxlength="160" value="{rowcontent.ghichutour}" id="ghichutour" name="ghichutour" style="width:100%" placeholder="Đăng ký từ 3 khách có giảm 5%" /--></td>
...
<div class="message_head">	<cite>{LANG.thongtinkhachsan}</cite></div>
<table border="0" width="100%" cellpadding="2"  class="table table-striped table-bordered table-hover">
<col class="w200" />
				<col />
				<tbody>	

<tr></td><td style=" width: 15%;   line-height: 29px;" >{LANG.loaikhachsan}</td><td style=" width: 32%;  line-height: 29px; " ><input class="form-control" type="text" maxlength="160" value="{rowcontent.loaikhachsan}" id="loaikhachsan" name="loaikhachsan" style="width:100%"  placeholder="3 sao"/></td>
</td><td style=" width: 15%;   line-height: 29px;" >{LANG.loaiphong}</td><td style=" width: 32%;  line-height: 29px; " ><input class="form-control" type="text" maxlength="160" value="{rowcontent.loaiphong}" id="loaiphong" name="loaiphong" style="width:100%"  placeholder="Phòng đôi"/></td>

</tr>
<tr></td><td>{LANG.giaphong}</td><td><input class="form-control" type="text" maxlength="160" value="{rowcontent.giaphong}" id="giaphong" name="giaphong" style="width:100%" placeholder="400.000đ/đêm" /></td>
</td><td>{LANG.tiennghiks}</td><td><input class="form-control" type="text" maxlength="160" value="{rowcontent.tiennghiks}" id="tiennghiks" name="tiennghiks" style="width:100%"  placeholder="Tiêu chuẩn 3 sao"/></td>

</tr>
<tr></td><td>{LANG.tiennghitp}</td><td><input class="form-control" type="text" maxlength="160" value="{rowcontent.tiennghitp}" id="tiennghitp" name="tiennghitp" style="width:100%" placeholder="internet, máy lạnh, tivi" /></td>
</td><td>{LANG.ghichuks}<br>{LANG.chapnhanthe}</td><td>

<textarea id="ghichuks" name="ghichuks" rows="5" cols="75" style="font-size:14px; width: 100%; height:50px;" class="form-control" placeholder="Cuối tuần và ngày lễ tăng 5% " >{rowcontent.ghichuks}</textarea>

<!--input class="form-control" type="text" maxlength="160" value="{rowcontent.ghichuks}" id="ghichuks" name="ghichuks" style="width:100%"/--></td></td>
 </tr>
</tbody></table>
			...
			<table border="0" cellpadding="2" width="100%" class="table table-striped table-bordered table-hover"><col class="w200" />	<col />
	<tr>
		<td style="width: 15%;text-align: center;"><strong>{LANG.content_copyright} </strong></td>
		<td style="width: 55%;text-align: center;"><strong>{LANG.content_sourceid}</strong></td>
		<td style="width: 30%;text-align: center;"><strong>{LANG.content_author}</strong></td>
	</tr>
	<tr>
		<td style=" text-align: center; ">
		 <input type="checkbox" value="1" name="copyright"{checkcop} checked />
		...
		<td><input class="form-control" type="text" maxlength="255" value="{rowcontent.author}" name="author" style="width:100%"  placeholder="Thiên Minh Vương"/></td>
	</tr>
