...
if( !nv_function_exists( 'nv_news_category' ) )
{
	...
	function nv_news_category( $block_config )
	{
		...
		if( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/travel/block_category.tpl' ) )
		{
		...
		$xtpl = new XTemplate( 'block_category.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/travel' );
