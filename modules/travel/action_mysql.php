...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows (
	...
	giatour  text NOT NULL,
	matour  text NOT NULL,
	tiente  text NOT NULL,
	donvitinh  text NOT NULL,
	hanhtrinh  text NOT NULL,
	khoihanh  text NOT NULL,
	ketthuc  text NOT NULL,
	thoigian  text NOT NULL,
	ghichutour  text NOT NULL,
	loaikhachsan  text NOT NULL,
	loaiphong  text NOT NULL,
	giaphong  text NOT NULL,
	tiennghiks  text NOT NULL,
	tiennghitp  text NOT NULL,
	ghichuks  text NOT NULL,
