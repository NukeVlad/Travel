...
if( $nv_Request->get_int( 'save', 'post' ) == 1 )
{
	...
	$rowcontent['giatour'] = $nv_Request->get_textarea( 'giatour', 'post', '' );
	$rowcontent['matour'] = $nv_Request->get_textarea( 'matour', 'post', '' );
	$rowcontent['tiente'] = $nv_Request->get_textarea( 'tiente', 'post', '' );
	$rowcontent['donvitinh'] = $nv_Request->get_textarea( 'donvitinh', 'post', '' );
	$rowcontent['hanhtrinh'] = $nv_Request->get_textarea( 'hanhtrinh', 'post', '' );
	$rowcontent['khoihanh'] = $nv_Request->get_textarea( 'khoihanh', 'post', '' );
	$rowcontent['ketthuc'] = $nv_Request->get_textarea( 'ketthuc', 'post', '' );
	$rowcontent['thoigian'] = $nv_Request->get_textarea( 'thoigian', 'post', '' );
	$rowcontent['ghichutour'] = $nv_Request->get_textarea( 'ghichutour', 'post', '' );
	$rowcontent['loaikhachsan'] = $nv_Request->get_textarea( 'loaikhachsan', 'post', '' );
	$rowcontent['loaiphong'] = $nv_Request->get_textarea( 'loaiphong', 'post', '' );
	$rowcontent['giaphong'] = $nv_Request->get_textarea( 'giaphong', 'post', '' );
	$rowcontent['tiennghiks'] = $nv_Request->get_textarea( 'tiennghiks', 'post', '' );
	$rowcontent['tiennghitp'] = $nv_Request->get_textarea( 'tiennghitp', 'post', '' );
	$rowcontent['ghichuks'] = $nv_Request->get_textarea( 'ghichuks', 'post', '' );
	...
	if( empty( $error ) )
	{
		...
		if( $rowcontent['id'] == 0 )
		{
			...
			$sql = 'INSERT INTO ' . NV_PREFIXLANG . '_' . $module_data . '_rows
				(catid, listcatid, topicid, admin_id, author, sourceid, addtime, edittime, status, publtime, exptime, archive, title, alias, hometext, giatour, matour, tiente, donvitinh, hanhtrinh, khoihanh, ketthuc, thoigian, ghichutour, loaikhachsan, loaiphong, giaphong, tiennghiks, tiennghitp, ghichuks, homeimgfile, homeimgalt, homeimgthumb, inhome, allowed_comm, allowed_rating, hitstotal, hitscm, total_rating, click_rating) VALUES
			...
			$data_insert['giatour'] = $rowcontent['giatour'];
			$data_insert['matour'] = $rowcontent['matour'];
			$data_insert['tiente'] = $rowcontent['tiente'];
			$data_insert['donvitinh'] = $rowcontent['donvitinh'];
			$data_insert['hanhtrinh'] = $rowcontent['hanhtrinh'];
			$data_insert['khoihanh'] = $rowcontent['khoihanh'];
			$data_insert['ketthuc'] = $rowcontent['ketthuc'];
			$data_insert['thoigian'] = $rowcontent['thoigian'];
			$data_insert['ghichutour'] = $rowcontent['ghichutour'];
			$data_insert['loaikhachsan'] = $rowcontent['loaikhachsan'];
			$data_insert['loaiphong'] = $rowcontent['loaiphong'];
			$data_insert['giaphong'] = $rowcontent['giaphong'];
			$data_insert['tiennghiks'] = $rowcontent['tiennghiks'];
			$data_insert['tiennghitp'] = $rowcontent['tiennghitp'];
			$data_insert['ghichuks'] = $rowcontent['ghichuks'];
		...
		else
		{
			...
			$sth = $db->prepare( 'UPDATE ' . NV_PREFIXLANG . '_' . $module_data . '_rows SET
					...
					ketthuc=:ketthuc,
					thoigian=:thoigian,
					ghichutour=:ghichutour,
					loaikhachsan=:loaikhachsan,
					loaiphong=:loaiphong,
					giaphong=:giaphong,
					tiennghiks=:tiennghiks,
					tiennghitp=:tiennghitp,
					ghichuks=:ghichuks,
			...
			$sth->bindParam( ':giatour', $rowcontent['giatour'], PDO::PARAM_STR, strlen( $rowcontent['giatour'] ) );
			$sth->bindParam( ':matour', $rowcontent['matour'], PDO::PARAM_STR, strlen( $rowcontent['matour'] ) );
			$sth->bindParam( ':tiente', $rowcontent['tiente'], PDO::PARAM_STR, strlen( $rowcontent['tiente'] ) );
			$sth->bindParam( ':donvitinh', $rowcontent['donvitinh'], PDO::PARAM_STR, strlen( $rowcontent['donvitinh'] ) );
			$sth->bindParam( ':hanhtrinh', $rowcontent['hanhtrinh'], PDO::PARAM_STR, strlen( $rowcontent['hanhtrinh'] ) );
			$sth->bindParam( ':khoihanh', $rowcontent['khoihanh'], PDO::PARAM_STR, strlen( $rowcontent['khoihanh'] ) );
			$sth->bindParam( ':ketthuc', $rowcontent['ketthuc'], PDO::PARAM_STR, strlen( $rowcontent['ketthuc'] ) );
			$sth->bindParam( ':thoigian', $rowcontent['thoigian'], PDO::PARAM_STR, strlen( $rowcontent['thoigian'] ) );
			$sth->bindParam( ':ghichutour', $rowcontent['ghichutour'], PDO::PARAM_STR, strlen( $rowcontent['ghichutour'] ) );
			$sth->bindParam( ':loaikhachsan', $rowcontent['loaikhachsan'], PDO::PARAM_STR, strlen( $rowcontent['loaikhachsan'] ) );
			$sth->bindParam( ':loaiphong', $rowcontent['loaiphong'], PDO::PARAM_STR, strlen( $rowcontent['loaiphong'] ) );
			$sth->bindParam( ':giaphong', $rowcontent['giaphong'], PDO::PARAM_STR, strlen( $rowcontent['giaphong'] ) );
			$sth->bindParam( ':tiennghiks', $rowcontent['tiennghiks'], PDO::PARAM_STR, strlen( $rowcontent['tiennghiks'] ) );
			$sth->bindParam( ':tiennghitp', $rowcontent['tiennghitp'], PDO::PARAM_STR, strlen( $rowcontent['tiennghitp'] ) );
			$sth->bindParam( ':ghichuks', $rowcontent['ghichuks'], PDO::PARAM_STR, strlen( $rowcontent['ghichuks'] ) );			
