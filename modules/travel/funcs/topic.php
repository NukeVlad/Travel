...
else
{
	...
	$result = $db->query( 'SELECT topicid as id, title, alias, image, description as hometext,  giatour, matour, tiente, donvitinh, hanhtrinh, khoihanh, ketthuc, thoigian, ghichutour, loaikhachsan, loaiphong, giaphong, tiennghiks, tiennghitp, ghichuks, keywords, add_time as publtime FROM ' . NV_PREFIXLANG . '_' . $module_data . '_topics ORDER BY weight ASC' );
	while( $item = $result->fetch() )
	{
