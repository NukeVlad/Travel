...
if( ! nv_function_exists( 'nv_news_block_tophits' ) )
{
	...
	function nv_news_block_tophits( $block_config, $mod_data )
	{
		...
		if( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme']  . '/modules/travel/block_news.tpl' ) )
		{
		...
		$xtpl = new XTemplate( 'block_news.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/travel' );
